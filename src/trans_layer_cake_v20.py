...
if __name__ == "__main__":
    ...
    print(f"Max sequence length supported by the model: {max_length}")

    if max_length > 512 or max_length == int(1e30):  # Handle excessive or default values
        print(f"Invalid max_length ({max_length}) detected. Adjusting to 512.")
        max_length = 512
    ...
    #logfile.insert(dimensions=dimensions, epoch=epoch, measure=f'{measure_prefix}-loss', value=loss, timelapse=tend)
