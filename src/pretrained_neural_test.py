...
from util.common import get_word_list

from data.lc_dataset import LCDataset, loadpt_data

from util.common import index_dataset
...
def main():
    ...
    pretrained_embeddings, sup_range = embedding_matrix(lcd, pretrained_vectors, vocabsize, word2index, out_of_vocabulary)
