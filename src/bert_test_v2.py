...
from util.common import get_embedding_type, initialize_testing, index_dataset
...
def fine_tune_model(args, device, batch_size=MPS_BATCH_SIZE, epochs=EPOCHS, max_length=TOKEN_TOKENIZER_MAX_LENGTH, layers_to_unfreeze=0, model_name='bert-base-uncased'):
    ...
    word2index, out_of_vocabulary, unk_index, pad_index, devel_index, test_index = index_dataset(lcd, args, pretrained_vectors)
