...
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained glove	--supervised
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained glove	--supervised	--tunable
...
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained word2vec	--supervised
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained word2vec	--supervised	--tunable
...
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained fasttext	--supervised
$PY $LOG $dataset	$ATTN	--hidden 1024	--pretrained fasttext	--supervised	--tunable
# ---------------------------------------------------------------------------------------------------------------------------------------
...
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained glove
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained glove	--tunable
$PY $LOG $dataset	$LSTM	--learnable 101	--hidden 1024	--pretrained glove	--tunable --droptype learn
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained glove	--supervised	--tunable
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained glove	--supervised

$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained word2vec
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained word2vec	--tunable
$PY $LOG $dataset	$LSTM	--learnable 101	--hidden 1024	--pretrained word2vec	--tunable --droptype learn
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained word2vec	--supervised	--tunable
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained word2vec	--supervised

$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained fasttext
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained fasttext	--tunable
$PY $LOG $dataset	$LSTM	--learnable 101	--hidden 1024	--pretrained fasttext	--tunable --droptype learn
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained fasttext	--supervised	--tunable
$PY $LOG $dataset	$LSTM	--hidden 1024	--pretrained fasttext	--supervised
