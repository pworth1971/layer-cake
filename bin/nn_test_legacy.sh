...
do
    ...
    $PY $LOG $dataset	$CNN	--channels 128	--pretrained bert --seed $run
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert	--tunable --seed $run
    #$PY $LOG $dataset	$CNN	--learnable 5	--channels 128	--pretrained bert	--tunable --seed $run --droptype learn
    $PY $LOG $dataset	$CNN	--channels 128	--pretrained bert	--supervised --seed $run
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert	--supervised	--tunable --seed $run
    ...
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert   --lr 1e-5 --dropprob .25 --seed $run
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert   --lr 1e-5 --dropprob .25	--tunable --seed $run
    #$PY $LOG $dataset	$CNN	--learnable 20	--channels 128	--pretrained bert   --lr 1e-5 --dropprob .25	--tunable --seed $run --droptype learn
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert   --lr 1e-5 --dropprob .25	--supervised --seed $run
    #$PY $LOG $dataset	$CNN	--channels 128	--pretrained bert   --lr 1e-5 --dropprob .25 --supervised	--tunable --seed $run
    ...
    $PY $LOG $dataset	$CNN	--channels 512	--pretrained bert --seed $run
    #$PY $LOG $dataset	$CNN	--channels 512	--pretrained bert	--tunable --seed $run
    #$PY $LOG $dataset	$CNN	--learnable 23	--channels 512	--pretrained bert	--tunable --seed $run --droptype learn
    $PY $LOG $dataset	$CNN	--channels 256	--pretrained bert	--supervised --seed $run
    #$PY $LOG $dataset	$CNN	--channels 256	--pretrained bert	--supervised	--tunable --seed $run
